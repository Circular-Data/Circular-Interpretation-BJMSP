  ...
  for(j in 1:7){
    for(k in 1:5){
      for(z in 1:5){
        ...
        Sumres <- read.table(file=paste("Paper 3 simulations/ResultsN=200/result", B0I[k], ",", B1I[i], ",", B0II[z], ",", B1II[j], ".txt", sep=""), sep="\t")
        #load results for whether HPD SSDO contains 0
        load(file = paste("Paper 3 simulations/ResultsN=200/Accuracyindicator", B0I[k], ",", B1I[i], ",", B0II[z], ",", B1II[j], ".Rdata", sep=""))
        #load results for whether HPDs of either B1I or B1II do not contain 0
        load(file = paste("Paper 3 simulations/ResultsN=200/NoEffindicator", B0I[k], ",", B1I[i], ",", B0II[z], ",", B1II[j], ".Rdata", sep=""))
        #load results for whether HPDs of Bc, AS (mBC) and SAM (BxmX) contain 0
        load(file = paste("Paper 3 simulations/ResultsN=200/ZeroEffBc", B0I[k], ",", B1I[i], ",", B0II[z], ",", B1II[j], ".Rdata", sep=""))
        load(file = paste("Paper 3 simulations/ResultsN=200/ZeroEffmBc", B0I[k], ",", B1I[i], ",", B0II[z], ",", B1II[j], ".Rdata", sep=""))
        load(file = paste("Paper 3 simulations/ResultsN=200/ZeroEffBcmX", B0I[k], ",", B1I[i], ",", B0II[z], ",", B1II[j], ".Rdata", sep=""))
...
pdf("Paper 3 simulations/Plots/FigureBiasAcmeasBcBN.pdf", family = "CM Roman", pointsize = 24)
...
pdf("Paper 3 simulations/Plots/FigureBiasAcmeasBcmXBN.pdf", family = "CM Roman", pointsize = 24)
PopulationSD  <- c(AcmeasLoc[,1], AcmeasLocI[,1], AcmeasA[,1])
...
pdf("Paper 3 simulations/Plots/FigureCoverageAcmeasmBcBN.pdf", family = "CM Roman", pointsize = 24)
PopulationSD <- c(AcmeasLoc[,1], AcmeasLocI[,1], AcmeasA[,1])
...
pdf("Paper 3 simulations/Plots/FigureAIWAcmeasBcBN.pdf", family = "CM Roman", pointsize = 24)
PopulationSD <- c(AcmeasLoc[,1], AcmeasLocI[,1], AcmeasA[,1])
